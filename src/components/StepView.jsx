    ...
    <div className="w-full max-w-3xl mx-auto px-4 py-6 flex flex-col flex-1">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs uppercase font-extrabold tracking-widest text-[#7cfc00]">
        ...
        {!isPlaying ? (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="text-xs text-slate-300 mt-1 max-w-sm font-medium line-clamp-1">
                {step.videoTitle}
              </p>
            </div>
          </div>
      ...
      {step.showMinuteCode && (
        <div className="mb-6 py-2">
          ...
          <div className="flex items-center gap-4 py-2">
            ...
            {/* Botón copiar código con forma KGEN */}
            <button
      ...
      <div className="mb-8 space-y-3">
        <h3 className="text-xs uppercase font-black tracking-wider text-slate-400 flex items-center gap-2 mb-3">
          <CheckCircle2 className="w-4 h-4 text-[#7cfc00]" />
          Pasos a seguir:
        </h3>

        {step.instructions.map((inst, idx) => (
          <div key={idx} className="flex items-start gap-3 text-slate-200 text-sm sm:text-base leading-relaxed py-1">
      ...
      {/* 4. BOTONES IDÉNTICOS A LA CAPTURA DE KGEN */}
      <div className="space-y-3 mb-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2 text-xs font-mono font-bold text-slate-400 hover:text-[#7cfc00] transition-all"
        >
          {copiedReferral ? (
            <>
      ...
      {/* 5. BOTONES DE NAVEGACIÓN (IDÉNTICOS AL PAR DETALLES / INICIAR) */}
